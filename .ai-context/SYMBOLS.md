...
tests/test_audit_report.py: TestRenderReport, TestRetryLoops, TestSessionIdent, TestRunReport
...
tests/test_version.py: test_pyproject_declares_a_version, test_installed_metadata_matches_pyproject